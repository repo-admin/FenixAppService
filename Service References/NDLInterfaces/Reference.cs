...
namespace FenixAppService.NDLInterfaces {
    ...
    public interface PortTypeNDL_Interfaces {
        ...
        FenixAppService.NDLInterfaces.UPWSI0Response UPWSI0(FenixAppService.NDLInterfaces.UPWSI0Request request);
        
        [System.ServiceModel.OperationContractAttribute(Action="", ReplyAction="*")]
        System.Threading.Tasks.Task<FenixAppService.NDLInterfaces.UPWSI0Response> UPWSI0Async(FenixAppService.NDLInterfaces.UPWSI0Request request);
    }
    ...
    public partial class UPWSI0Request {
        ...
        public FenixAppService.NDLInterfaces.UPWSI0RequestBody Body;
        
        public UPWSI0Request() {
        }
        
        public UPWSI0Request(FenixAppService.NDLInterfaces.UPWSI0RequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class UPWSI0Response {
        ...
        public FenixAppService.NDLInterfaces.UPWSI0ResponseBody Body;
        
        public UPWSI0Response() {
        }
        
        public UPWSI0Response(FenixAppService.NDLInterfaces.UPWSI0ResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface PortTypeNDL_InterfacesChannel : FenixAppService.NDLInterfaces.PortTypeNDL_Interfaces, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class PortTypeNDL_InterfacesClient : System.ServiceModel.ClientBase<FenixAppService.NDLInterfaces.PortTypeNDL_Interfaces>, FenixAppService.NDLInterfaces.PortTypeNDL_Interfaces {
        ...
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        FenixAppService.NDLInterfaces.UPWSI0Response FenixAppService.NDLInterfaces.PortTypeNDL_Interfaces.UPWSI0(FenixAppService.NDLInterfaces.UPWSI0Request request) {
        ...
        public byte[] UPWSI0(string login, string password, string partnerCode, string messageType, string characterEncoding, byte[] image) {
            FenixAppService.NDLInterfaces.UPWSI0Request inValue = new FenixAppService.NDLInterfaces.UPWSI0Request();
            inValue.Body = new FenixAppService.NDLInterfaces.UPWSI0RequestBody();
            ...
            FenixAppService.NDLInterfaces.UPWSI0Response retVal = ((FenixAppService.NDLInterfaces.PortTypeNDL_Interfaces)(this)).UPWSI0(inValue);
            return retVal.Body.UPWSI0Return;
        }
        
        [System.ComponentModel.EditorBrowsableAttribute(System.ComponentModel.EditorBrowsableState.Advanced)]
        System.Threading.Tasks.Task<FenixAppService.NDLInterfaces.UPWSI0Response> FenixAppService.NDLInterfaces.PortTypeNDL_Interfaces.UPWSI0Async(FenixAppService.NDLInterfaces.UPWSI0Request request) {
            return base.Channel.UPWSI0Async(request);
        }
        
        public System.Threading.Tasks.Task<FenixAppService.NDLInterfaces.UPWSI0Response> UPWSI0Async(string login, string password, string partnerCode, string messageType, string characterEncoding, byte[] image) {
            FenixAppService.NDLInterfaces.UPWSI0Request inValue = new FenixAppService.NDLInterfaces.UPWSI0Request();
            inValue.Body = new FenixAppService.NDLInterfaces.UPWSI0RequestBody();
            inValue.Body.login = login;
            inValue.Body.password = password;
            ...
            inValue.Body.characterEncoding = characterEncoding;
            inValue.Body.image = image;
            return ((FenixAppService.NDLInterfaces.PortTypeNDL_Interfaces)(this)).UPWSI0Async(inValue);
        }
    }
}
